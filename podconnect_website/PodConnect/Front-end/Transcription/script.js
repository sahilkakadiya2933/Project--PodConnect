...
const divButtonLoading = document.getElementById("loading-container");
const divButton = document.getElementById("transcribe-button");
...
form.addEventListener('submit', async(event) => {
  ...
  divButtonLoading.style.display="inline-block";
  ...
  divButtonLoading.style.display="none";
  divButton.style.display="block";
  audioDropBox.disabled=true;
  document.getElementById("audioDropBoxButton").disabled=true;
